...
wpa_supplicant_prepare_interface() {
	...
	[ -n "$country" ] && {
        ...
        if [ "$freq" -ge "2412" ]; then
                scan_list="2412 2417 2422 2427 2432 2437 2442 2447 2452 2457 2462 2467 2472"
        fi

        if [ "$freq" -ge "5180" ]; then
                scan_list="5180 5200 5220 5240 5260 5280 5300 5320"
        fi

        if [ "$freq" -ge "5500" ]; then
                scan_list="5500 5520 5540 5560 5580 5600 5620 5640 5660 5680 5700 5720"
        fi

        if [ "$freq" -ge "5745" ]; then
                scan_list="5745 5765 5785 5805 5825 5845 5865 5885"
        fi
